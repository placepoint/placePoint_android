...
class MyLiveFeedAdapter (private val context: Context, private val list: ArrayList<ModelHome>, var  liveFeedFragment: MyLiveFeedFragment) :
        RecyclerView.Adapter<MyLiveFeedAdapter.ViewHolder>(), LifecycleObserver {
